...
Despite SNMP consisting of and consuming a number of RFCs and standards, there
isn't a file extension or set of file extensions that can be matched to
help determine whether or not a file is a MIB or another alternative plaintext
format.
